...
type RoleCreateRequest struct {
	...
	Status   entity.RoleStatus `json:"status" binding:"required,oneof='1' '0'"`
...
type RoleUpdateRequest struct {
	...
	RoleStatus entity.RoleStatus `json:"roleStatus" binding:"required,oneof='1' '0'"`
	Remark     string            `json:"remark" binding:"omitempty,max=255"`
}
...
type RoleResponse struct {
	...
	RoleStatus entity.RoleStatus `json:"roleStatus"`
