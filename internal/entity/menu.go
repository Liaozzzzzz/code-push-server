...
// Menu 菜单实体模型
type Menu struct {
	MenuID      int64             `json:"menuId" gorm:"type:bigint(20);primaryKey;autoIncrement;comment:'菜单ID'"`
	MenuName    string            `json:"menuName" gorm:"type:varchar(50);not null;uniqueIndex;comment:'菜单名称'"`
	ParentID    int64             `json:"parentId" gorm:"type:bigint(20);not null;default:0;comment:'父菜单ID'"`
	...
	Sort        int32             `json:"sort" gorm:"type:int(11);not null;default:0;comment:'菜单排序'"`
	Status      types.MenuStatus  `json:"status" gorm:"type:enum('1','0');default:'1';comment:'状态'"`
