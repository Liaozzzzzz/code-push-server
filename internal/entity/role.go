...
// Role 角色实体模型
type Role struct {
	RoleID    int64            `json:"roleId" gorm:"type:bigint(20);primaryKey;autoIncrement;comment:'角色ID'"`
	...
	Status    types.RoleStatus `json:"status" gorm:"type:enum('1','0');default:'1';comment:'状态'"`
