...
type User struct {
	...
	Nickname   types.NullString `json:"nickname" gorm:"type:varchar(50);comment:'昵称'"`
	...
	Avatar     types.NullString `json:"avatar" gorm:"type:varchar(255);default:null;comment:'头像'"`
	AckCode    types.NullString `json:"ackCode" gorm:"type:varchar(255);default:null;comment:'验证码'"`
